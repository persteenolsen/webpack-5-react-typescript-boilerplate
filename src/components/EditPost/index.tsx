		   ...
		   <div>
             ...
             <div className="table-responsive">
				 ...
				 <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input name="titlePost" size={30} ref={register({ required: true, maxLength: 75 })} defaultValue={selectedPostTitle} />
                    ...
                    <br /> 
					 ...
					 <input name="bodyPost" size={30} ref={register({ required: true, maxLength: 300 })} defaultValue={selectedPostBody} />
